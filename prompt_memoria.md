...
## Visão geral
- Webapp minimalista que permite colar a URL de um vídeo e obter uma transcrição automática do áudio. Atualmente aceita YouTube (vídeos comuns) e Reels públicos do Instagram.
...
- Frontend leve (HTML/CSS/JS vanilla) com um único formulário, feedback de origem detectada e um card de resultados.
